...
export const SPAS: Spa[] = [
  ...
  {
    slug: "8-10-blue",
    name: "8–10 Seater Spa — Light Blue",
    seats: "Seats 8–10",
    jets: 6,
    short: "Light blue marble octagonal interior with 6 full-flow jets, air massage, timber access step, stainless handrail and fast LPG gas heating.",
    image: spa810Blue,
  },
  {
    slug: "12-seater",
